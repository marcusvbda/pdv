                                ...
                                <table class="table table-sm table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="f-12">Preço</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="(product, i) in products_list" :key="i" style="cursor: pointer" @click="selecting.product_id = product.id">
                                            <td class="f-12">{{ product.code }}</td>
                                            <td class="f-12">
            ...
            <template v-else>
                <div class="row mt-3">
                    <div class="col-12 d-flex flex-row">
                        <div class="image-list-preview d-flex align-items-center justify-content-center">
                            <el-image
                                class="image big"
                                :src="selected_product.images > 0 ? selected_product.images[0] : '/assets/placeholder.jpg'"
                                :preview-src-list="selected_product.images > 0 ? selected_product.images : []"
                            />
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input class="form form-control form-control-sm" v-model="selecting.disccount" type="number" min="0" :max="selected_product.price" />
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="d-flex flex-row justify-content-end">
                            <el-button-group>
                                <el-button type="danger">
                                    <div class="d-flex flex-row align-items-center" @click="cancelSelection">
...
export default {
    ...
    computed: {
        ...
        selecting_product_total() {
            ...
            return (price - disccount + addition).currency()
        },
        selected_product() {
